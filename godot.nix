  ...
  mkTarget =
    ...
    let
      ...
      attrs = finalAttrs: rec {
        ...
        #   owner = "itepastra";
        #   repo = "godot";
        #   rev = "6a97402b67da36f84ba2b097d89b3d42312b0283";
        #   hash = "sha256-AMf/MvgOxmzNjxG1svV3yu1Th86cli5+AYWAnqgfk7A=";
        ...
        // lib.optionalAttrs editor {
          ...
          export-templates-bin = (
            callPackage ./export-templates-bin.nix {
              ...
              hash = "sha256-eo0UreSJ/U0i8XgZMCH+iodqnlEGjtTd4m2sOuTFmog=";
            }
          );
        };
